...
import com.isoft.iaas.openstack.swift.model.Container;
...
public class ContainersResource {
	...
	public class Create extends OpenStackRequest<Container> {
		...
		public Create(String containerName) {
			// return
			// target.path(containerName).request().method("PUT",Entity.text("*"));
		}
	...
	public class Show extends OpenStackRequest<Container> {
		...
		public Show(String containerName) {
			// return
			// target.path(containerName).request(MediaType.APPLICATION_JSON).head();
		}
	...
	public class Delete extends OpenStackRequest<Void> {
		...
		public Delete(String containerName) {
			...
			// return
			// target.path(containerName).request(MediaType.APPLICATION_JSON).delete();
		}
