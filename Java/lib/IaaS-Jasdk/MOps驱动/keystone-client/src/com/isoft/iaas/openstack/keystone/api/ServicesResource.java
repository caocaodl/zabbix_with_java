...
public class ServicesResource {
	...
	public class List extends OpenStackRequest<Services> {
		...
		public List() {
			super(client, HttpMethod.GET, "/OS-KSADM/services", null,
					Services.class);
		}
	...
	public class Create extends OpenStackRequest<Service> {
		...
		public Create(Service service) {
			super(client, HttpMethod.POST, "/OS-KSADM/services", Entity
					.json(service), Service.class);
		}
	...
	public class Show extends OpenStackRequest<Service> {
		...
		public Show(String id) {
			super(client, HttpMethod.GET, new StringBuilder(
					"/OS-KSADM/services/").append(id).toString(), null,
					Service.class);
		}
