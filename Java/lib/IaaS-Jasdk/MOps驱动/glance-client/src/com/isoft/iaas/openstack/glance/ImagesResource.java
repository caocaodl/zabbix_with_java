package com.isoft.iaas.openstack.glance;
...
import com.isoft.iaas.openstack.glance.model.ImageDownload;
import com.isoft.iaas.openstack.glance.model.ImageMember;
import com.isoft.iaas.openstack.glance.model.ImageMembers;
import com.isoft.iaas.openstack.glance.model.ImageUpload;
...
public class ImagesResource {
	...
	public ReplaceMembers replaceMembers(String id,
			Collection<ImageMember> members) {
	...
	public class Update extends OpenStackRequest<Image> {
		...
		public Update(String id, Image image) {
			super(CLIENT, HttpMethod.PUT, new StringBuilder("/images/").append(
					id).toString(), Entity.json(image), Image.class);
		}
	...
	public class Show extends OpenStackRequest<Image> {
		...
		public Show(String id) {
			super(CLIENT, HttpMethod.HEAD, new StringBuilder("/images/")
	...
	public class Upload extends OpenStackRequest<Image> {
		...
		public Upload(ImageUpload imageUpload) {
			super(CLIENT, HttpMethod.POST, "/images", Entity.stream(imageUpload
					.getInputStream()), Image.class);

			for (Map.Entry<String, String> entry : compose(
					imageUpload.getImage()).entrySet()) {
				header(entry.getKey(), entry.getValue());
			}
	...
	public class Download extends OpenStackRequest<ImageDownload> {
		...
		public Download(String id) {
			super(CLIENT, HttpMethod.GET, new StringBuilder("/images/").append(
					id).toString(), null, ImageDownload.class);
	...
	public class ListMembers extends OpenStackRequest<ImageMembers> {
		...
		public ListMembers(String id) {
			super(CLIENT, HttpMethod.GET, new StringBuilder("/images/")
					.append(id).append("/members").toString(), null,
					ImageMembers.class);
		}
	...
	public class ReplaceMembers extends OpenStackRequest<Void> {
		...
		public ReplaceMembers(String id, Collection<ImageMember> members) {
			super(CLIENT, HttpMethod.PUT, new StringBuilder("/images/")
					.append(id).append("/members").toString(), Entity
					.json(new Memberships(members)), Void.class);
		}
	...
	public class AddMember extends OpenStackRequest<ImageMember> {
		...
		public AddMember(String id, String tenantId) {
			super(CLIENT, HttpMethod.PUT, new StringBuilder("/images/")
					.append(id).append("/members").append(tenantId).toString(),
					null, ImageMember.class);
		}
	...
	public class RemoveMember extends OpenStackRequest<Void> {
		...
		public RemoveMember(String id, String tenantId) {
			super(CLIENT, HttpMethod.DELETE,
					new StringBuilder("/images/").append(id)
							.append("/members/").append(tenantId).toString(),
					null, Void.class);
		}
	...
	public static Map<String, String> compose(Image image) {
		...
		headers.put("X-Image-Meta-Size", (image.getSize() != null) ? image
				.getSize().toString() : null);
		...
		for (String key : image.getProperties().keySet()) {
			image.getProperties().put("x-image-meta-property-" + key,
					image.getProperties().get(key));
		}
