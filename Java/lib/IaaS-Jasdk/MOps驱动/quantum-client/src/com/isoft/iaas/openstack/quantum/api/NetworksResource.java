...
public class NetworksResource {
	...
	public class Query extends OpenStackRequest<Networks> {
		...
		public Query(Network network) {
			...
			// return
			// target.request(MediaType.APPLICATION_JSON).get(Networks.class);
		}
	}
	...
	public class Create extends OpenStackRequest<Network> {
		...
		public Create(Network net) {
			super(CLIENT, HttpMethod.POST, "networks", Entity.json(net),
					Network.class);
		}
	}
	...
	public class Update extends OpenStackRequest<Network> {
		...
		public Update(Network net) {
			super(CLIENT, HttpMethod.PUT, buildPath("networks/", net.getId()),
					Entity.json(net), Network.class);
		}
	}
	...
	public class Show extends OpenStackRequest<Network> {
		...
		public Show(String id) {
			super(CLIENT, HttpMethod.GET, buildPath("networks/", id), null,
					Network.class);
		}
	}
	...
	public class Delete extends OpenStackRequest<Void> {
		...
		public Delete(String id) {
			super(CLIENT, HttpMethod.DELETE, buildPath("networks/", id), null,
					Void.class);
		}
	}
}
