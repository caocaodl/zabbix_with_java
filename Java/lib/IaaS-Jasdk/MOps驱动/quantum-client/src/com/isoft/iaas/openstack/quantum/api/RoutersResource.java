...
import com.isoft.iaas.openstack.quantum.model.RouterInterface;
...
public class RoutersResource {
	...
	public class Create extends OpenStackRequest<Router> {
		...
		public Create(RouterForCreate router) {
			super(CLIENT, HttpMethod.POST, "routers", Entity.json(router),
					Router.class);
		}
	}
	...
	public class Show extends OpenStackRequest<Router> {
		...
		public Show(String id) {
			super(CLIENT, HttpMethod.GET, buildPath("routers/", id), null,
					Router.class);
		}
	}
	...
	public class Delete extends OpenStackRequest<Void> {
		...
		public Delete(String id) {
			super(CLIENT, HttpMethod.DELETE, buildPath("routers/", id), null,
					Void.class);
		}
	}
