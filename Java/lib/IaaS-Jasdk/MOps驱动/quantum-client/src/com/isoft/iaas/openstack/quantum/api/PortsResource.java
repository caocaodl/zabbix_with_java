...
public class PortsResource {
	...
	public class Query extends OpenStackRequest<Ports> {
		...
		public Query(Port port) {
			...
			// return
			// target.request(MediaType.APPLICATION_JSON).get(Ports.class);
		}
	...
	public class Create extends OpenStackRequest<Port> {
		...
		public Create(Port port) {
			super(CLIENT, HttpMethod.POST, "ports", Entity.json(port),
					Port.class);
		}
	}
	...
	public class Update extends OpenStackRequest<Port> {
		...
		public Update(Port port) {
			super(CLIENT, HttpMethod.PUT, buildPath("ports/", port.getId()),
					Entity.json(port), Port.class);
		}
	}
	...
	public class Show extends OpenStackRequest<Port> {
		...
		public Show(String id) {
			super(CLIENT, HttpMethod.GET, buildPath("ports/", id), null,
					Port.class);
		}
	}
	...
	public class Delete extends OpenStackRequest<Void> {
		...
		public Delete(String id) {
			super(CLIENT, HttpMethod.DELETE, buildPath("ports/", id), null,
					Void.class);
		}
	}
}
