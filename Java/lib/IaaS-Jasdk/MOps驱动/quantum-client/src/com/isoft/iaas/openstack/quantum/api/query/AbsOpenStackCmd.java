package com.isoft.iaas.openstack.quantum.api.query;
...
public class AbsOpenStackCmd<T> extends OpenStackRequest<T> {
	...
	/*
	 * public WebTarget queryParam(WebTarget target) { Map<String, String> map =
	 * getObjectParamMap(this.query); for (String fieldName : map.keySet()) {
	 * target = target.queryParam(fieldName, map.get(fieldName)); } return
	 * target; }
	 */
