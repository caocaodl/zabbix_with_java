...
public class OpenStackClient {
	...
	public <T> T execute(OpenStackRequest<T> request) {
		...
		return (request.returnType() != null && request.returnType() != Void.class) ? response
				.getEntity(request.returnType()) : null;
	}
	...
	public <R> OpenStackRequest<R> get(String path, Class<R> returnType) {
		return new OpenStackRequest<R>(this, HttpMethod.GET, path, null,
				returnType);
	}
