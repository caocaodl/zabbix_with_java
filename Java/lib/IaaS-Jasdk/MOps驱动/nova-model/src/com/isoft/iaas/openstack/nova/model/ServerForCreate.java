...
public class ServerForCreate implements Serializable {
	...
	private List<NetworkForAssign> networks = new ArrayList<NetworkForAssign>();
	...
	public List<NetworkForAssign> getNetworks() {
		return networks;
	}

	public void setNetworks(List<NetworkForAssign> networks) {
		this.networks = networks;
	}

	public void addNetworks(String id, String fixedIp) {
		NetworkForAssign net = new NetworkForAssign();
		net.setId(id);
