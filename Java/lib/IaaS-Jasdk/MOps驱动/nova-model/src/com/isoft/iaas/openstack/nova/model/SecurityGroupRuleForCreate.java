...
public class SecurityGroupRuleForCreate implements Serializable {
	 ...
	 */
	@Deprecated
	public SecurityGroupRuleForCreate(Integer parentSecurityGroupId,
	 ...
	 */
	@Deprecated
	public SecurityGroupRuleForCreate(Integer parentGroupId, String ipProtocol,
			Integer fromPort, Integer toPort, Integer sourceGroupId) {
	...
	public SecurityGroupRuleForCreate(String parentSecurityGroupId,
			String ipProtocol, Integer fromPort, Integer toPort, String cidr) {
	...
	public SecurityGroupRuleForCreate(String parentGroupId,
