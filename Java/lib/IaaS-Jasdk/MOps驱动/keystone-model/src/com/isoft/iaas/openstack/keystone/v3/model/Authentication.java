...
public class Authentication implements Serializable {
	...
	public static final class Identity {
		...
		public static final Identity password(String domainName,
				String username, String password) {
			Identity identity = new Identity();
			identity.getMethods().add("password");
			Password method = new Password();
			com.isoft.iaas.openstack.keystone.v3.model.Authentication.Identity.Password.User.Domain domain = new com.isoft.iaas.openstack.keystone.v3.model.Authentication.Identity.Password.User.Domain();
	...
	public static final class Scope {
		...
		public static Scope project(String domainName, String projectName) {
			Scope scope = new Scope();
			com.isoft.iaas.openstack.keystone.v3.model.Authentication.Scope.Project.Domain domain = new com.isoft.iaas.openstack.keystone.v3.model.Authentication.Scope.Project.Domain();
			domain.setName(domainName);
			Project project = new Project();
