...
import com.isoft.iaas.openstack.nova.model.HostAggregate;
import com.isoft.iaas.openstack.nova.model.HostAggregates;
...
public class AggregatesExtension {
	...
	public class List extends OpenStackRequest<HostAggregates> {
		...
		public List() {
			super(CLIENT, HttpMethod.GET, "/os-aggregates", null,
	...
	public class ShowAggregate extends OpenStackRequest<HostAggregate> {
		...
		public ShowAggregate(String id) {
			super(CLIENT, HttpMethod.GET, new StringBuffer("/os-aggregates/")
					.append(id), null, HostAggregate.class);
		}
	...
	public class UpdateAggregateMetadata extends
		...
		public UpdateAggregateMetadata(String id, String name,
				String availabilityZone) {
			super(CLIENT, HttpMethod.PUT, new StringBuffer("/os-aggregates/")
					.append(id), availabilityZone == null ? Entity
					.json("{\"aggregate\": {\"name\": \"" + name + "\" }}")
					: Entity.json("{\"aggregate\": {\"name\": \"" + name
							+ "\", \"availability_zone\": \""
							+ availabilityZone + "\" }}"), HostAggregate.class);
		}
	...
	public class DeleteAggregate extends OpenStackRequest<Void> {
		...
		public DeleteAggregate(String id) {
			super(CLIENT, HttpMethod.DELETE,
					new StringBuffer("/os-aggregates/").append(id), null, null);
		}
	}
	...
	public class AddHost extends OpenStackRequest<HostAggregate> {
		...
		public AddHost(String aggregateId, String hostId) {
			super(CLIENT, HttpMethod.POST, new StringBuffer("/os-aggregates/")
					.append(aggregateId).append("/action"), Entity
					.json("{\"add_host\": {\"host\": \"" + hostId + "\" }}"),
					HostAggregate.class);
		}
	...
	public class RemoveHost extends OpenStackRequest<HostAggregate> {
		...
		public RemoveHost(String hostId, String aggregateId) {
			super(CLIENT, HttpMethod.POST, new StringBuffer("/os-aggregates/")
					...
					Entity.json("{\"remove_host\": {\"host\": \"" + hostId
							+ "\" }}"), HostAggregate.class);
		}
	...
	public class SetMetadata extends OpenStackRequest<HostAggregate> {
		...
		public SetMetadata(String aggregateId, String key, String value) {
			super(CLIENT, HttpMethod.POST, new StringBuffer("/os-aggregates/")
					.append(aggregateId).append("/action"), Entity
					.json("{\"set_metadata\": {\"metadata\": { \"" + key
							+ "\": \"" + value + "\" }}}"), HostAggregate.class);
		}
	}
}
