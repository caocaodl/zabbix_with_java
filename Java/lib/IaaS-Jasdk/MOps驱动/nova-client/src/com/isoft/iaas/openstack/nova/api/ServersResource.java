...
import com.isoft.iaas.openstack.nova.model.Server.Addresses;
import com.isoft.iaas.openstack.nova.model.ServerAction.ChangePassword;
import com.isoft.iaas.openstack.nova.model.ServerAction.ConfirmResize;
import com.isoft.iaas.openstack.nova.model.ServerAction.ConsoleOutput;
import com.isoft.iaas.openstack.nova.model.ServerAction.CreateBackup;
import com.isoft.iaas.openstack.nova.model.ServerAction.CreateImage;
import com.isoft.iaas.openstack.nova.model.ServerAction.GetConsoleOutput;
import com.isoft.iaas.openstack.nova.model.ServerAction.GetVncConsole;
import com.isoft.iaas.openstack.nova.model.ServerAction.LiveMigration;
import com.isoft.iaas.openstack.nova.model.ServerAction.Lock;
import com.isoft.iaas.openstack.nova.model.ServerAction.Migrate;
import com.isoft.iaas.openstack.nova.model.ServerAction.Pause;
import com.isoft.iaas.openstack.nova.model.ServerAction.Reboot;
import com.isoft.iaas.openstack.nova.model.ServerAction.Rebuild;
import com.isoft.iaas.openstack.nova.model.ServerAction.Rescue;
import com.isoft.iaas.openstack.nova.model.ServerAction.ResetState;
import com.isoft.iaas.openstack.nova.model.ServerAction.Resize;
import com.isoft.iaas.openstack.nova.model.ServerAction.Resume;
import com.isoft.iaas.openstack.nova.model.ServerAction.RevertResize;
import com.isoft.iaas.openstack.nova.model.ServerAction.Start;
import com.isoft.iaas.openstack.nova.model.ServerAction.Stop;
import com.isoft.iaas.openstack.nova.model.ServerAction.Suspend;
import com.isoft.iaas.openstack.nova.model.ServerAction.Unlock;
import com.isoft.iaas.openstack.nova.model.ServerAction.Unpause;
import com.isoft.iaas.openstack.nova.model.ServerAction.Unrescue;
import com.isoft.iaas.openstack.nova.model.ServerAction.VncConsole;
import com.isoft.iaas.openstack.nova.model.ServerForCreate;
import com.isoft.iaas.openstack.nova.model.Servers;
import com.isoft.iaas.openstack.nova.model.VolumeAttachment;
import com.isoft.iaas.openstack.nova.model.VolumeAttachments;
...
public class ServersResource {
	...
	public Diagnostics diagnostics(String id) {
	...
	public class Boot extends OpenStackRequest<Server> {
		...
		public Boot(ServerForCreate server) {
			super(CLIENT, HttpMethod.POST, "/servers", Entity.json(server),
					Server.class);
		}

	}
	
	public class Diagnostics extends OpenStackRequest<Map> {

		public Diagnostics(String id) {
			super(CLIENT, HttpMethod.GET, new StringBuilder("/servers/")
					.append(id).append("/diagnostics"), null, Map.class);
		}
	...
	public class ShowMetadata extends OpenStackRequest<Metadata> {
		...
		public ShowMetadata(String id) {
			super(CLIENT, HttpMethod.GET, new StringBuilder("/servers/")
					.append(id).append("/metadata"), null, Metadata.class);
		}
	...
	public class CreateOrUpdateMetadata extends OpenStackRequest<Metadata> {
		...
		public CreateOrUpdateMetadata(String id, Metadata metadata) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/metadata"), Entity.json(metadata),
					Metadata.class);
		}
	...
	public class ReplaceMetadata extends OpenStackRequest<Metadata> {
		...
		public ReplaceMetadata(String id, Metadata metadata) {
			super(CLIENT, HttpMethod.PUT, new StringBuilder("/servers/")
					.append(id).append("/metadata"), Entity.json(metadata),
					Metadata.class);
		}
	...
	public class DeleteMetadata extends OpenStackRequest<Void> {
		...
		public DeleteMetadata(String id, String key) {
			super(CLIENT, HttpMethod.DELETE, new StringBuilder("/servers/")
					.append(id).append("/metadata/").append(key), null,
					Void.class);
		}
	...
	public class ShowServerAddresses extends OpenStackRequest<Addresses> {
		...
		public ShowServerAddresses(String id) {
			super(CLIENT, HttpMethod.GET, new StringBuilder("/servers/")
					.append(id).append("/ips"), null, Addresses.class);
		}
	...
	public class UpdateServer extends OpenStackRequest<Server> {
		...
		public UpdateServer(String id, Server server) {
			super(CLIENT, HttpMethod.PUT, new StringBuilder("/servers/")
					.append(id), Entity.json(server), Server.class);
		}
	...
	public abstract class Action<T> extends OpenStackRequest<T> {
		...
		public Action(String id, Entity<?> entity, Class<T> returnType) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), entity, returnType);
		}
	...
	public class StartServer extends OpenStackRequest<Void> {
		...
		public StartServer(String id) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(new Start()),
					Void.class);
		}
	...
	public class StopServer extends OpenStackRequest<Void> {
		...
		public StopServer(String id) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(new Stop()),
					Void.class);
		}
	...
	public class PauseServer extends OpenStackRequest<Void> {
		...
		public PauseServer(String id) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(new Pause()),
					Void.class);
		}
	...
	public class UnpauseServer extends OpenStackRequest<Void> {
		...
		public UnpauseServer(String id) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(new Unpause()),
					Void.class);
		}
	...
	public class LockServer extends OpenStackRequest<Void> {
		...
		public LockServer(String id) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(new Lock()),
					Void.class);
		}
	...
	public class UnlockServer extends OpenStackRequest<Void> {
		...
		public UnlockServer(String id) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(new Unlock()),
					Void.class);
		}
	...
	public class SuspendServer extends OpenStackRequest<Void> {
		...
		public SuspendServer(String id) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(new Suspend()),
					Void.class);
		}
	...
	public class ResumeServer extends OpenStackRequest<Void> {
		...
		public ResumeServer(String id) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(new Resume()),
					Void.class);
		}
	...
	public class MigrateServer extends OpenStackRequest<Void> {

		public MigrateServer(String id) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(new Migrate()),
					Void.class);
		}

	}
	
	public class LiveMigrationServer extends OpenStackRequest<Void> {

		public LiveMigrationServer(String id, LiveMigration action) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(action),
					Void.class);
		}
	...
	public MigrateServer migrate(String serverId) {
		return new MigrateServer(serverId);
	}

	public LiveMigrationServer liveMigration(String serverId, LiveMigration action) {
		return new LiveMigrationServer(serverId, action);
	}
	...
	public class ResetStateServer extends OpenStackRequest<Void> {

		public ResetStateServer(String id, ResetState action) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(action),
					Void.class);
		}
	...
	public ResetStateServer resetState(String serverId, String state) {
		ResetState action = new ResetState(state);
		return new ResetStateServer(serverId, action);
	}
	...
	public class AssociateFloatingIp extends OpenStackRequest<Void> {
		...
		public AssociateFloatingIp(
				String id,
				com.isoft.iaas.openstack.nova.model.ServerAction.AssociateFloatingIp action) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(action),
					Void.class);
		}
	...
	public class DisassociateFloatingIp extends OpenStackRequest<Void> {
		...
		public DisassociateFloatingIp(
				String id,
				com.isoft.iaas.openstack.nova.model.ServerAction.DisassociateFloatingIp action) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(id).append("/action"), Entity.json(action),
					Void.class);
		}
	...
	public AssociateFloatingIp associateFloatingIp(String serverId,
		...
		com.isoft.iaas.openstack.nova.model.ServerAction.AssociateFloatingIp action = new com.isoft.iaas.openstack.nova.model.ServerAction.AssociateFloatingIp(
				floatingIpAddress);
	...
	public DisassociateFloatingIp disassociateFloatingIp(String serverId,
			String floatingIpAddress) {
		com.isoft.iaas.openstack.nova.model.ServerAction.DisassociateFloatingIp action = new com.isoft.iaas.openstack.nova.model.ServerAction.DisassociateFloatingIp(
				floatingIpAddress);
	...
	public class AttachVolume extends OpenStackRequest<Void> {
		...
		public AttachVolume(String serverId,
				final VolumeAttachment volumeAttachment) {
			super(CLIENT, HttpMethod.POST, new StringBuilder("/servers/")
					.append(serverId).append("/os-volume_attachments"), Entity
					.json(volumeAttachment), Void.class);
		}
