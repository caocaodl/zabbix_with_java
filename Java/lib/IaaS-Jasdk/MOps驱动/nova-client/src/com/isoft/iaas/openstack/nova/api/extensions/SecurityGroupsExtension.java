...
import com.isoft.iaas.openstack.nova.model.SecurityGroupForCreate;
import com.isoft.iaas.openstack.nova.model.SecurityGroupRuleForCreate;
import com.isoft.iaas.openstack.nova.model.SecurityGroups;
...
public class SecurityGroupsExtension {
	...
	public class Create extends OpenStackRequest<SecurityGroup> {
		...
		public Create(SecurityGroupForCreate securityGroupForCreate) {
			super(CLIENT, HttpMethod.POST, "/os-security-groups", Entity
					.json(securityGroupForCreate), SecurityGroup.class);
		}
	...
	public class Show extends OpenStackRequest<SecurityGroup> {
		...
		public Show(Integer id) {
			super(CLIENT, HttpMethod.GET, new StringBuilder(
					"/os-security-groups/").append(id).toString(), null,
					SecurityGroup.class);
		}
	...
	public class Delete extends OpenStackRequest<Void> {
		...
		public Delete(Integer id) {
			super(CLIENT, HttpMethod.DELETE, new StringBuilder(
					"/os-security-groups/").append(String.valueOf(id))
	...
	public class CreateRule extends OpenStackRequest<SecurityGroup.Rule> {
		...
		public CreateRule(SecurityGroupRuleForCreate securityGroupRuleForCreate) {
			super(CLIENT, HttpMethod.POST, "/os-security-group-rules", Entity
					.json(securityGroupRuleForCreate), SecurityGroup.Rule.class);
		}
	}
	...
	public class DeleteRule extends OpenStackRequest<Void> {
		...
		public DeleteRule(Integer id) {
			super(CLIENT, HttpMethod.DELETE, new StringBuilder(
					"/os-security-group-rules/").append(String.valueOf(id))
					.toString(), null, Void.class);
		}
	 ...
	 */
	public CreateRule createSecurityGroupRule(Integer parentSecurityGroupId,
			String ipProtocol, Integer fromPort, Integer toPort, String cidr) {
	...
	public CreateRule createSecurityGroupRule(String parentSecurityGroupId,
			String ipProtocol, Integer fromPort, Integer toPort, String cidr) {
		SecurityGroupRuleForCreate securityGroupRuleForCreate = new SecurityGroupRuleForCreate(
				parentSecurityGroupId, ipProtocol, fromPort, toPort, cidr);
		return new CreateRule(securityGroupRuleForCreate);
	...
	public CreateRule createSecurityGroupRule(String parentSecurityGroupId,
			String sourceGroupId, String ipProtocol, Integer fromPort,
			Integer toPort) {
		SecurityGroupRuleForCreate securityGroupRuleForCreate = new SecurityGroupRuleForCreate(
				parentSecurityGroupId, sourceGroupId, ipProtocol, fromPort,
				toPort);
		return new CreateRule(securityGroupRuleForCreate);
	}
