...
public class CConfigurationScreenConstructorList extends CViewSegment {
	...
	public CWidget doWidget(IIdentityBean idBean, SQLExecutor executor, Map data) {
		...
		screenWidget.addHeader(Nest.value(data,"screen","name").$());
		if (!empty(Nest.value(data,"screen","templateid").$())) {
			screenWidget.addItem(get_header_host_table(idBean, executor, "screens", Nest.value(data,"screen","templateid").asLong(true)));
		}
