...
public class LatestAction extends RadarBaseAction {
	...
	public void doAction(SQLExecutor executor) {
		...
		latestWidget.addPageHeader(_("LATEST DATA"), get_icon(getIdentityBean(), executor, "fullscreen", map("fullscreen", Nest.value(_REQUEST,"fullscreen").$())));
