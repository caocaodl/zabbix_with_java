...
public class ItemsAction extends RadarBaseAction {
	...
	public void doAction(final SQLExecutor executor) {
		...
		if (isset(_REQUEST,"filter_set")) {
			...
			CProfile.update(getIdentityBean(), executor,"web.items.filter_groupid", Nest.value(_REQUEST,"filter_groupid").$(), PROFILE_TYPE_ID);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_hostid", Nest.value(_REQUEST,"filter_hostid").$(), PROFILE_TYPE_ID);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_application", Nest.value(_REQUEST,"filter_application").$(), PROFILE_TYPE_STR);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_name", Nest.value(_REQUEST,"filter_name").$(), PROFILE_TYPE_STR);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_type", Nest.value(_REQUEST,"filter_type").$(), PROFILE_TYPE_INT);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_key", Nest.value(_REQUEST,"filter_key").$(), PROFILE_TYPE_STR);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_snmp_community", Nest.value(_REQUEST,"filter_snmp_community").$(), PROFILE_TYPE_STR);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_snmpv3_securityname", Nest.value(_REQUEST,"filter_snmpv3_securityname").$(), PROFILE_TYPE_STR);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_snmp_oid", Nest.value(_REQUEST,"filter_snmp_oid").$(), PROFILE_TYPE_STR);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_port", Nest.value(_REQUEST,"filter_port").$(), PROFILE_TYPE_STR);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_value_type", Nest.value(_REQUEST,"filter_value_type").$(), PROFILE_TYPE_INT);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_data_type", Nest.value(_REQUEST,"filter_data_type").$(), PROFILE_TYPE_INT);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_delay", Nest.value(_REQUEST,"filter_delay").$(), PROFILE_TYPE_STR);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_history", Nest.value(_REQUEST,"filter_history").$(), PROFILE_TYPE_STR);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_trends", Nest.value(_REQUEST,"filter_trends").$(), PROFILE_TYPE_STR);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_status", Nest.value(_REQUEST,"filter_status").$(), PROFILE_TYPE_INT);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_state", Nest.value(_REQUEST,"filter_state").$(), PROFILE_TYPE_INT);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_templated_items", Nest.value(_REQUEST,"filter_templated_items").$(), PROFILE_TYPE_INT);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_with_triggers", Nest.value(_REQUEST,"filter_with_triggers").$(), PROFILE_TYPE_INT);
			CProfile.update(getIdentityBean(), executor,"web.items.filter_ipmi_sensor", Nest.value(_REQUEST,"filter_ipmi_sensor").$(), PROFILE_TYPE_STR);

			// subfilters
			for (String name : subfiltersList) {
				Nest.value(_REQUEST,name).$(array());
				CProfile.update(getIdentityBean(), executor,"web.items."+name, "", PROFILE_TYPE_STR);
			}
		} else {
			Nest.value(_REQUEST,"filter_groupid").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_groupid"));
			Nest.value(_REQUEST,"filter_hostid").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_hostid"));
			Nest.value(_REQUEST,"filter_application").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_application"));
			Nest.value(_REQUEST,"filter_name").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_name"));
			Nest.value(_REQUEST,"filter_type").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_type", -1));
			Nest.value(_REQUEST,"filter_key").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_key"));
			Nest.value(_REQUEST,"filter_snmp_community").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_snmp_community"));
			Nest.value(_REQUEST,"filter_snmpv3_securityname").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_snmpv3_securityname"));
			Nest.value(_REQUEST,"filter_snmp_oid").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_snmp_oid"));
			Nest.value(_REQUEST,"filter_port").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_port"));
			Nest.value(_REQUEST,"filter_value_type").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_value_type", -1));
			Nest.value(_REQUEST,"filter_data_type").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_data_type", -1));
			Nest.value(_REQUEST,"filter_delay").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_delay"));
			Nest.value(_REQUEST,"filter_history").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_history"));
			Nest.value(_REQUEST,"filter_trends").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_trends"));
			Nest.value(_REQUEST,"filter_status").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_status"));
			Nest.value(_REQUEST,"filter_state").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_state"));
			Nest.value(_REQUEST,"filter_templated_items").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_templated_items", -1));
			Nest.value(_REQUEST,"filter_with_triggers").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_with_triggers", -1));
			Nest.value(_REQUEST,"filter_ipmi_sensor").$(CProfile.get(getIdentityBean(), executor,"web.items.filter_ipmi_sensor"));

			// subfilters
			for (String name : subfiltersList) {
				if (isset(_REQUEST,"subfilter_set")) {
					Nest.value(_REQUEST,name).$(get_request(name, array()));
					CProfile.update(getIdentityBean(), executor,"web.items+"+name, implode(";", Nest.array(_REQUEST,name).asString()), PROFILE_TYPE_STR);
				} else {
					Nest.value(_REQUEST,name).$(array());
					String subfiltersVal = Nest.as(CProfile.get(getIdentityBean(), executor,"web.items."+name)).asString();
		...
		if (!isset(_REQUEST,"form") && isset(_REQUEST,"filter_hostid") && !empty(Nest.value(_REQUEST,"filter_hostid").$())) {
			if (!isset(host)) {
				CArray<Map> hosts = (CArray) API.Host(getIdentityBean(), executor).getObjects(map("hostid" , Nest.value(_REQUEST,"filter_hostid").$()));
				if (empty(hosts)) {
					hosts = API.Template(getIdentityBean(), executor).getObjects((Map)map("hostid" , Nest.array(_REQUEST,"filter_hostid").asString()));
				}
				host = reset(hosts);
			}
			if (!empty(host)) {
				Nest.value(_REQUEST,"hostid").$(isset(host,"hostid") ? Nest.value(host,"hostid").$() : Nest.value(host,"templateid").$());
			}
		}		
		...
		// mass update
			...
			if (isset(_REQUEST,"copy_targetid") && !empty(Nest.value(_REQUEST,"copy_targetid").asCArray()) && isset(_REQUEST,"copy_type")) {
				final CArray hosts_ids;
				if (Nest.value(_REQUEST,"copy_type").asLong() == 0) {// host
					hosts_ids = Nest.value(_REQUEST,"copy_targetid").asCArray();
				} else {// groups
					hosts_ids = new CArray();
		...
		// clean history for selected items
			...
			boolean goResult = Call(new Wrapper<Boolean>() {
				@Override
				protected Boolean doCall() throws Throwable {
					return delete_history_by_itemid(executor, Nest.value(_REQUEST,"group_itemid").asLong());
				}
			});
		...
		if (isset(_REQUEST,"form") && str_in_array(Nest.value(_REQUEST,"form").asString(), array(_("Create item"), "update", "clone"))) {
			Map data = getItemFormData(this.getIdentityBean(), executor);
			...
			hoptions.setItemIds(Nest.array(data,"itemids").asLong());
			...
			if (hostCount > 1) {
				...
				toptions.setItemIds(Nest.array(data,"itemids").asLong());
				...
				if (hostCount == 1 && Nest.value(data,"displayInterfaces").asBoolean()) {
					...
					CItemGet ioptions = new CItemGet();
					ioptions.setItemIds(rda_objectValues(Nest.value(hosts,"items").asCArray(), "itemid").valuesAsLong());
		...
		// list of items
			...
			Nest.value(data,"flicker").$(getItemFilterForm(this.getIdentityBean(), executor, items));
			...
			Nest.value(data,"triggerRealHosts").$(getParentHostsByTriggers(this.getIdentityBean(), executor,itemTriggers));
