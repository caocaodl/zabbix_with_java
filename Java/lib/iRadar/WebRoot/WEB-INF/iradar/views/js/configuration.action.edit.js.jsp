...
<tr id="opGroupRow_#{groupid}">
    ...
    <td>
        <input type="button" class="input link_menu" name="remove" value="<%=_("Remove")%>" onclick="removeOpGroupRow('#{groupid}');" />
    </td>
</tr>
</script>
...
<tr id="opTemplateRow_#{templateid}">
    ...
    <td>
        <input type="button" class="input link_menu" name="remove" value="<%=_("Remove")%>" onclick="removeOpTemplateRow('#{templateid}');" />
    </td>
</tr>
</script>
...
<tr id="opmsgUsrgrpRow_#{usrgrpid}">
    ...
    <td>
        <input type="button" class="input link_menu" name="remove" value="<%=_("Remove")%>" onclick="removeOpmsgUsrgrpRow('#{usrgrpid}');" />
    </td>
</tr>
</script>
...
<tr id="opmsgUserRow_#{userid}">
    ...
    <td>
        <input type="button" class="input link_menu" name="remove" value="<%=_("Remove")%>" onclick="removeOpmsgUserRow('#{userid}');" />
    </td>
</tr>
</script>
...
<tr id="opCmdGroupRow_#{groupid}">
    ...
    <td>
        <input type="button" class="input link_menu" name="remove" value="<%=_("Remove")%>" onclick="removeOpCmdRow('#{groupid}', 'groupid');" />
    </td>
</tr>
</script>
...
<tr id="opCmdHostRow_#{hostid}">
    ...
    <td>
        <input type="button" class="input link_menu" name="remove" value="<%=_("Remove")%>" onclick="removeOpCmdRow('#{hostid}', 'hostid');" />
    </td>
</tr>
</script>
    ...
    <table class="objectgroup border_dotted ui-corner-all inlineblock" style="min-width: 310px;">
        ...
        <tr>
            <td colspan="3">
                ...
                <input type="button" class="input link_menu" name="cancel" value="<%=_("Cancel")%>" />
            </td>
        </tr>
        </tbody>
    </table>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        jQuery('#select_opcommand_script').click(function() {
            PopUp('popup.action?srctbl=scripts&srcfld1=scriptid&srcfld2=name&dstfrm=action.edit&dstfld1=new_operation_opcommand_scriptid&dstfld2=new_operation_opcommand_script', 480, 720);
        });
