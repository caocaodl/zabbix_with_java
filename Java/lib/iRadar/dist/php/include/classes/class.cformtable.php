...
class CFormTable extends CForm {
	...
	protected $top_items = CArray.array();
	protected $center_items = CArray.array();
	protected $bottom_items = CArray.array();
	...
	public function __construct($title = null, $action = null, $method = null, $enctype = null, $form_variable = null) {
		...
		addVar($form_variable, get_request($form_variable, 1));
	...
	public function setAction($value) {
		...
		elseif (is_null($value)) {
			...
			return error("Incorrect value for setAction \"".$value."\".");
		}
	}

	public function setName($value) {
		if (!is_string($value)) {
			return error("Incorrect value for setAlign \"".$value."\".");
		}
		attr("name", $value);
		attr("id", zbx_formatDomId($value));
		return true;
	}
	...
	public function addSpanRow($value, $class = null) {
		...
		$col.setColSpan(2);
		array_push(center_items, new CRow($col));
	}
	...
	public function bodyToString() {
		...
		$tbl = new CTable(null, tableclass);
