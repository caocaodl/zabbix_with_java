...
class CAutoloader {
	 ...
	 * @var array
	 */
	protected $includePaths = CArray.array();
	...
	public function register() {
		return spl_autoload_register(CArray.array($this, "loadClass"));
	}
	...
	protected function loadClass($className) {
		if ($classFile = findClassFile($className)) {
			require $classFile;
		}
	}
	...
	protected function findClassFile($className) {
		...
		for(includePaths as $includePath) {
