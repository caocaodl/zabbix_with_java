...
$fields = CArray.array(
	"type" =>				CArray.array(T_ZBX_STR, O_OPT, null,	IN("\"".ZBX_DB_MYSQL."\",\"".ZBX_DB_POSTGRESQL."\",\"".ZBX_DB_ORACLE."\",\"".ZBX_DB_DB2."\",\"".ZBX_DB_SQLITE3."\""), null),
	"server" =>				CArray.array(T_ZBX_STR, O_OPT, null,	null,				null),
	"port" =>				CArray.array(T_ZBX_INT, O_OPT, null,	BETWEEN(0, 65535),	null, _("Database port")),
	"database" =>			CArray.array(T_ZBX_STR, O_OPT, null,	NOT_EMPTY,			null, _("Database name")),
	"user" =>				CArray.array(T_ZBX_STR, O_OPT, null,	null,				null),
	"password" =>			CArray.array(T_ZBX_STR, O_OPT, null,	null, 				null),
	"schema" =>				CArray.array(T_ZBX_STR, O_OPT, null,	null, 				null),
	"zbx_server" =>			CArray.array(T_ZBX_STR, O_OPT, null,	null,				null),
	"zbx_server_name" =>	CArray.array(T_ZBX_STR, O_OPT, null,	null,				null),
	"zbx_server_port" =>	CArray.array(T_ZBX_INT, O_OPT, null,	BETWEEN(0, 65535),	null, _("Port")),
	"message" =>			CArray.array(T_ZBX_STR, O_OPT, null,	null,				null),
	// actions
	"save_config" =>		CArray.array(T_ZBX_STR, O_OPT, P_SYS,	null,				null),
	"retry" =>				CArray.array(T_ZBX_STR, O_OPT, P_SYS,	null,				null),
	"cancel" =>				CArray.array(T_ZBX_STR, O_OPT, P_SYS,	null,				null),
	"finish" =>				CArray.array(T_ZBX_STR, O_OPT, P_SYS,	null,				null),
	"next" =>				CArray.array(T_ZBX_STR, O_OPT, P_SYS,	null,				null),
	"back" =>				CArray.array(T_ZBX_STR, O_OPT, P_SYS,	null,				null),
...
$ZBX_CONFIG = isset($ZBX_CONFIG) ? unserialize($ZBX_CONFIG) : CArray.array();
Nest.value($ZBX_CONFIG,"check_fields_result").$() = check_fields($fields, false);
if (!isset(Nest.value($ZBX_CONFIG,"step").$())) {
	Nest.value($ZBX_CONFIG,"step").$() = 0;
}
...
if (CWebUser::$data && CWebUser::getType() < USER_TYPE_SUPER_ADMIN) {
	...
	if (CWebUser::isGuest() && Nest.value($ZBX_CONFIG,"step").$() == 5 && hasRequest("finish")) {
	...
	elseif (!(CWebUser::isGuest() && Nest.value($ZBX_CONFIG,"step").$() == 5)) {
