...
public class FuncBody extends AndurilUIComponent {
	...
	public FuncBody(ValueStack stack, HttpServletRequest request,
...
//		encodeConsoleLayer(writer);
	...
	private void encodeNoticeLayer(HtmlResponseWriter writer) throws IOException {
