...
public class Query {
	...
	public Query(String _query, String _name, String _nodata, String _whenNotAlive, String _rccondq, String _rccondval, int _period, Boolean _active,
			Boolean _trim, Boolean _space, List<Integer> _excludeColumns, List<Integer> _raceExcludeColumns) {
