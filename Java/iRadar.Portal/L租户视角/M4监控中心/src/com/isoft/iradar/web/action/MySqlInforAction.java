 ...
 *
 */
public class MySqlInforAction extends RadarBaseAction{
	
	@Override
	protected void doInitPage() {
		page("title", _("Host detail"));
		page("file", "mysqlinfor.action");
	...
	public void doAction(SQLExecutor executor) {
		...
		if (hostid > 0) {
			...
			triggersForm.addItem(getLastTriggers(executor,hostid,0l,applicationid,APP_NAME_MYSQL));
			...
			CView hostinventoriesView = new CView("mysql.view", data);
