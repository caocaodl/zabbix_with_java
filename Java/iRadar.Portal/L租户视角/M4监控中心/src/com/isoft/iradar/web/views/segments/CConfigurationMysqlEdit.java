...
public class CConfigurationMysqlEdit extends CViewSegment {
	...
	public CWidget doWidget(IIdentityBean idBean, SQLExecutor executor, Map data) {
		...
		String host=Nest.value(data, "host").asString();
		
		String dbusername=Nest.value(data, "dbusername").asString();
		String dbuserpass=Nest.value(data, "dbuserpass").asString();
		String dbip=Nest.value(data, "dbip").asString();
		String dbport=Nest.value(data, "dbport").asString();
		String dbjavahome = Nest.value(data, "dbjavahome").asString();
		
		CTextBox nameTextBox = new CTextBox("name", name, RDA_TEXTBOX_STANDARD_SIZE,false);
		nameTextBox.setTitle(name);
		CTextBox dbusernameTextBox = new CTextBox("dbusername", dbusername, RDA_TEXTBOX_STANDARD_SIZE);
		CTextBox dbuserpassTextBox = new CTextBox("dbuserpass", dbuserpass, RDA_TEXTBOX_STANDARD_SIZE);
		CTextBox dbipTextBox = new CTextBox("dbip", dbip, RDA_TEXTBOX_STANDARD_SIZE);
		CTextBox dbportTextBox = new CTextBox("dbport", dbport, RDA_TEXTBOX_STANDARD_SIZE);
		CTextBox dbjavahomeTextBox = new CTextBox("dbjavahome", dbjavahome, RDA_TEXTBOX_STANDARD_SIZE);
		
		tvmFormList.addRow(_("Name"), nameTextBox);
		tvmFormList.addRow("数据库用户名", dbusernameTextBox);
		tvmFormList.addRow("数据库用户密码", dbuserpassTextBox);
		tvmFormList.addRow("数据库所在ip", dbipTextBox);
		tvmFormList.addRow("数据库端口号", dbportTextBox);
		tvmFormList.addRow("java路径", dbjavahomeTextBox);
		...
		tvmFormList.addRow(new CDiv(_("Item Frequency"),"sm_title"),severityDiv,false,"frequency_id","frequency_class");
		...
		//alarmtable.addRow(getalarmHeader(executor));
