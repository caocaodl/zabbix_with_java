...
import com.isoft.framework.core.concurrent.LogPreservingThreadFactory;
import com.isoft.framework.core.fiber.PausableFiber;
import com.isoft.framework.core.queue.FifoQueueImpl;
import com.isoft.imon.topo.core.utils.Assert;
 ...
 * 
 * @author <a href="mailto:mike@i-soft.com.cn">Mike Davidson </a>
 * @author <a href="mailto:weave@oculan.com">Brian Weaver </a>
 * @author <a href="http://www.i-soft.com.cn/">IMS </a>
 */
public class LegacyScheduler implements Runnable, PausableFiber, Scheduler {
	...
	public static final class PeekableFifoQueue<T> extends FifoQueueImpl<T> {
		 ...
		 * be returned on a <code>remove</code> call. If the queue is currently
		 * empty then the caller is blocked until an object is put into the
		 * queue.
		 * 
		 ...
		 * @throws com.isoft.ims.core.queue.FifoQueueException
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.isoft.ims.netmgt.scheduler.Scheduler#schedule(long, com.isoft.ims.netmgt.scheduler.ReadyRunnable)
	 */
	/** {@inheritDoc} */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.isoft.ims.netmgt.scheduler.Scheduler#getCurrentTime()
	 */
	/**
	 * <p>
	 * getCurrentTime
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.isoft.ims.netmgt.scheduler.Scheduler#start()
	 */
	/**
	 * <p>
	 * start
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.isoft.ims.netmgt.scheduler.Scheduler#stop()
	 */
	/**
	 * <p>
	 * stop
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.isoft.ims.netmgt.scheduler.Scheduler#pause()
	 */
	/**
	 * <p>
	 * pause
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.isoft.ims.netmgt.scheduler.Scheduler#resume()
	 */
	/**
	 * <p>
	 * resume
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.isoft.ims.netmgt.scheduler.Scheduler#getStatus()
	 */
	/**
	 * <p>
	 * getStatus
	...
	public void run() {
		...
		for (;;) {
						...
						try {
							...
							if (readyRun != null && readyRun.isReady()) {
								...
								if (m_runner instanceof ThreadPoolExecutor) {
									...
									String ratio = String.format("%.3f",
											e.getTaskCount() > 0 ? new Double(e.getCompletedTaskCount()) / new Double(e.getTaskCount()) : 0);
									LOG.debug(
											"thread pool statistics: activeCount={}, taskCount={}, completedTaskCount={}, completedRatio={}, poolSize={}",
			...
			/*
			 * Wait for 1 second if there were no runnables executed during this
			 * loop, otherwise just start over.
			 */
			synchronized (this) {
				m_scheduled -= runned;
				if (runned == 0) {
