...
delimiter $$
drop procedure if exists wk_history;
create procedure wk_history()
 BEGIN
  ...
  DECLARE cur CURSOR FOR select tenantid,itemid,clock,value,ns from history where clock between clock_from and clock_to;
    ...
    IF NOT done THEN
     	set i=1;    	 
      	...
      	begin
    		...
    		insert into history values(_tenantid,_itemid,__clock,_value,_ns);
    		set i = i +1;        
      	end;
   		end while;
    END IF;    
