...
delimiter $$
drop procedure if exists wk_trends_uint;
create procedure wk_trends_uint()
 BEGIN
  ...
  REPEAT   
    ...
    IF NOT done THEN
      	...
      	begin
    		...
    		insert into trends_uint values(_tenantid, _itemid, __clock, _num, _value_min, _value_avg, _value_max);
    		set i = i +1;        
      	end;
   		end while;
    END IF;    
