...
import com.isoft.web.bean.common.AnnounceAction;
...
public class AuditUtil {
	...
	public static CArray<String> audit_resource2str() {
		CArray<String> resources = map(
			...
			AnnounceAction.ANNOUNCEMENT_TYPE, _("system announcement")
		);
	...
	public static boolean add_audit(IIdentityBean idBean, SQLExecutor executor, int action, int resourcetype, String details) {
		...
		String ip = !empty(request.getHeader("X-Real-IP"))  ? request.getHeader("X-Real-IP")  : request.getRemoteAddr();
