...
public class CConfigurationHostDiscoveryList extends CViewSegment {
	...
	public CWidget doWidget(IIdentityBean idBean, SQLExecutor executor, Map data) {
		...
		for(Map discovery : (CArray<Map>)Nest.value(data,"discoveries").asCArray()) {
			...
			discoveryTable.addRow(array(
				...
				array(
					new CLink(
						_("Graph prototypes"),
						action+"?hostid="+get_request("hostid")+"&parent_discoveryid="+discovery.get("itemid")
					),
		...
		discoveryForm.addItem(array(discoveryTable, Nest.value(data,"paging").$(), get_table_header(array(goComboBox, goButton))));
