...
public class CAdministrationScriptEdit extends CViewSegment {
	...
	public CWidget doWidget(IIdentityBean idBean, SQLExecutor executor, Map data) {
		...
		// name
		CTextBox nameTextBox = new CTextBox("name", Nest.value(data,"name").asString(), 23,false,19);
		...
		scriptFormList.addVar("type", String.valueOf(RDA_SCRIPT_TYPE_CUSTOM_SCRIPT));
		...
		CTextArea txtarea = new CTextArea("command", Nest.value(data,"command").asString());
		...
		CTextArea txtdescription = new CTextArea("description", Nest.value(data,"description").asString());
...
//		}
		scriptFormList.addRow("", userGroups);
		...
		scriptFormList.addRow(new CLabel(_("startmessage"), "enableConfirmation"),
...
//			SPACE
//			,new CButton("testConfirmation", _("Test confirmation"), null, "link_menu update")
//		));
