...
import com.isoft.biz.daoimpl.radar.CTenantDAO;
...
public class API {
	 ...
	 * @return CActionDAO
	 */
	public static CTenantDAO Tenant(IIdentityBean idBean, SQLExecutor executor) {
		return new CTenantDAO(idBean, executor);
	}
