...
public class VolumesResource {
	...
	public class Update extends OpenStackRequest<Volume> {
		public Update(String id, Volume volume) {
			super(CLIENT, HttpMethod.PUT, new StringBuilder("/volumes/").append(id).toString(), Entity.json(volume), Volume.class);
		}
	}
	...
	public class BackStor extends OpenStackRequest<BackStorInfo> {
		public BackStor() {
			super(CLIENT, HttpMethod.GET, "/volumes/back_stor_info", null, BackStorInfo.class);
		}
	}
}
