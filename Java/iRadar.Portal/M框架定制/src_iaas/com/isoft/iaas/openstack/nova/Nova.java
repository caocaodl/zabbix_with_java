...
import com.isoft.iaas.openstack.nova.api.extensions.HypervisorsExtension;
...
import com.isoft.iaas.openstack.nova.api.extensions.OsConfigInfosExtension;
import com.isoft.iaas.openstack.nova.api.extensions.SecurityGroupsExtension;
import com.isoft.iaas.openstack.nova.api.extensions.ServicesExtension;
...
public class Nova extends OpenStackClient {
	...
	private final OsConfigInfosExtension OS_CONFIG_INFOS;
	...
	public Nova(String endpoint, OpenStackClientConnector connector) {
		...
		OS_CONFIG_INFOS = new OsConfigInfosExtension(this);
	}
	...
	public OsConfigInfosExtension osConfigInfos(){
		return OS_CONFIG_INFOS;
	}
}
