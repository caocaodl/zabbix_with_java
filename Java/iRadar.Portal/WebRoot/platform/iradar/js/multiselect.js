jQuery(function($) {
	...
	$.fn.multiSelectHelper = function(options) {
		...
		// url
		options.url = new Curl('jsrpc.action');
			...
			if (options.popup.parameters != null) {
				...
				if (options.disabled) {
					...
					popupButton.click(function() {
						return PopUp('popup.action?' + urlParameters, options.popup.width, options.popup.height);
					});
				}
