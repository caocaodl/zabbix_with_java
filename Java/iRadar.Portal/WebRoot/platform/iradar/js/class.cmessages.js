...
function initMessages(args) {
	var messagesListId = RDA_MESSAGES.length;
	RDA_MESSAGES[messagesListId] = new CMessageList(messagesListId, args);
...
var CMessageList = Class.create(CDebug, {
	...
	updateSettings: function() {
		...
		var rpcRequest = {
			...
			'onFailure': function() {
				rda_throw('Messages Widget: settings request failed.');
			}
		};
	...
	mute: function(e) {
		...
		var rpcRequest = {
			...
			'params': {},
			'onFailure': function() {
				rda_throw('Messages Widget: mute request failed.');
			}
		};
		new RPC.Call(rpcRequest);
		this.stopSound(e);
	...
	closeAllMessages: function() {
		...
		var rpcRequest = {
			...
			'onFailure': function(resp) {
				rda_throw('Messages Widget: message request failed.');
			}
		};
	...
	createContainer: function() {
		...
		this.dom.container = $('rda_messages');
		...
		// container
		this.dom.container.setAttribute('id', 'rda_messages');
