	...
	prototype: {
		...
		init: function() {
			...
			function delegate(event) {
				//alert(event.type); by zhukp
				var validator = $.data(this[0].form, "validator");
				validator.settings["on" + event.type] && validator.settings["on" + event.type].call(validator, this[0] );
			}
			$(this.currentForm)
				.delegate("focusin focusout keyup mouseover change", ":text, :password, :file, select, textarea", delegate)
				.delegate("click mouseover change", ":radio, :checkbox", delegate);
		...
		defaultShowErrors: function() { //by zhukp
		...
		showLabel: function(element, message) {//modify by zhukp
