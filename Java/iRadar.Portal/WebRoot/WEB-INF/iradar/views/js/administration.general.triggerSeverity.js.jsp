			...
			jQuery('#dialog').dialog({
				buttons: [
					{text: <%=CJs.encodeJson(Cphp._("Reset defaults"))%>, click: function(){
						jQuery('#severity_name_0').val("<%=Cphp._(Nest.value(schema,"fields","severity_name_0","default").asString())%>");
						jQuery('#severity_name_1').val("<%=Cphp._(Nest.value(schema,"fields","severity_name_1","default").asString())%>");
						jQuery('#severity_name_2').val("<%=Cphp._(Nest.value(schema,"fields","severity_name_2","default").asString())%>");
						jQuery('#severity_name_3').val("<%=Cphp._(Nest.value(schema,"fields","severity_name_3","default").asString())%>");
						jQuery('#severity_name_4').val("<%=Cphp._(Nest.value(schema,"fields","severity_name_4","default").asString())%>");
						jQuery('#severity_name_5').val("<%=Cphp._(Nest.value(schema,"fields","severity_name_5","default").asString())%>");
						jQuery('#severity_color_0').val("<%=Cphp._(Nest.value(schema,"fields","severity_color_0","default").asString())%>");
