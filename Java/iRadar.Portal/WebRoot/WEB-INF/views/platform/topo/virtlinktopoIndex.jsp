...
<body>
	...
	<script type="text/javascript" src="<%=basePath%>virtlinktopo/data/SoftTopo.AppConfig.js"></script>
	<script type="text/javascript" src="<%=basePath%>virtlinktopo/data/SoftTopo.AjaxUrl.js"></script>
	<script type="text/javascript" src="<%=basePath%>virtlinktopo/data/SoftTopo.AjaxData.js"></script>
	<script type="text/javascript" src="<%=basePath%>virtlinktopo/data/SoftTopo.Data.js"></script>
