...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>scripts/jquery/jquery-easyui-1.4.1/themes/icon.css"/>
	...
	<script type="text/javascript" src="<%=contextPath%>/assets/c/import/jquery-menu/js/jquery-menu.js"></script>
...
<body>
	...
	<script type="text/javascript" src="<%=basePath%>businesstopo/data/SoftTopo.AppConfig.js"></script>
	<script type="text/javascript" src="<%=basePath%>businesstopo/data/SoftTopo.AjaxUrl.js"></script>
	<script type="text/javascript" src="<%=basePath%>businesstopo/data/SoftTopo.AjaxData.js"></script>
	<script type="text/javascript" src="<%=basePath%>businesstopo/data/SoftTopo.Data.js"></script>
</body>
</html>
