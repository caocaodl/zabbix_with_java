...
<body>
	...
	<script type="text/javascript" src="<%=basePath%>virtlinktopo/tenant/data/SoftTopo.AppConfig.js"></script>
	<script type="text/javascript" src="<%=basePath%>virtlinktopo/tenant/data/SoftTopo.AjaxUrl.js"></script>
	<script type="text/javascript" src="<%=basePath%>virtlinktopo/tenant/data/SoftTopo.AjaxData.js"></script>
	<script type="text/javascript" src="<%=basePath%>virtlinktopo/tenant/data/SoftTopo.Data.js"></script>
</body>
</html>
