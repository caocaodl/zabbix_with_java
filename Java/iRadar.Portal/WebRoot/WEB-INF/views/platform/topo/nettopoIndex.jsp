...
<body >
	...
	<script type="text/javascript" src="<%=basePath%>physicaltopo/data/SoftTopo.AppConfig.js"></script>	
	<script type="text/javascript" src="<%=basePath%>physicaltopo/data/SoftTopo.AjaxUrl.js"></script>
	<script type="text/javascript" src="<%=basePath%>physicaltopo/data/SoftTopo.AjaxData.js"></script>
	<script type="text/javascript" src="<%=basePath%>physicaltopo/data/SoftTopo.Data.js"></script>
</body>
</html>
